    ...
    val buildConfigGenerator by tasks.registering(Sync::class) {
        ...
        from(
            resources.text.fromString(
                ...
                |  const val API_KEY_READ_STATUS = "${secretProperties.getPropertyValue("API_KEY_READ_STATUS")}"
                |  const val API_KEY_READ_CONTROLE = "${secretProperties.getPropertyValue("API_KEY_READ_CONTROLE")}"
                |  const val API_KEY_WRITE_SETPOINT = "${secretProperties.getPropertyValue("API_KEY_WRITE_SETPOINT")}"
                |  const val API_KEY_WRITE_STATUS = "${secretProperties.getPropertyValue("API_KEY_WRITE_STATUS")}"
                |  const val API_KEY_WRITE_CONTROLE = "${secretProperties.getPropertyValue("API_KEY_WRITE_CONTROLE")}"
                |  const val API_KEY_WRITE_TEMPERATURE = "${secretProperties.getPropertyValue("API_KEY_WRITE_TEMPERATURE")}"
                |  const val CHANNEL_ID_READ_SETPOINT = "${secretProperties.getPropertyValue("CHANNEL_ID_READ_SETPOINT")}"
                |  const val CHANNEL_ID_READ_STATUS = "${secretProperties.getPropertyValue("CHANNEL_ID_READ_STATUS")}"
                |  const val CHANNEL_ID_READ_CONTROLE = "${secretProperties.getPropertyValue("CHANNEL_ID_READ_CONTROLE")}"
